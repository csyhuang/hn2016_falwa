...
if __name__ == "__main__":
    ...
    # *** Output test data ***
    ds = xr.Dataset({
        "interpolated_u": (("levelist", "latitude", "longitude"), qgfield_object.interpolated_u),
        "interpolated_v": (("levelist", "latitude", "longitude"), qgfield_object.interpolated_v),
        "interpolated_theta": (("levelist", "latitude", "longitude"), qgfield_object.interpolated_theta),
        ...
        "adv_flux_f1": (("latitude", "longitude"), qgfield_object.adv_flux_f1),
        "adv_flux_f2": (("latitude", "longitude"), qgfield_object.adv_flux_f2),
        "adv_flux_f3": (("latitude", "longitude"), qgfield_object.adv_flux_f3),
        "divergence_eddy_momentum_flux": (("latitude", "longitude"), qgfield_object.divergence_eddy_momentum_flux),
        "convergence_zonal_advective_flux": (("latitude", "longitude"), qgfield_object.convergence_zonal_advective_flux),
        "meridional_heat_flux": (("latitude", "longitude"), qgfield_object.meridional_heat_flux)
    }, coords={
