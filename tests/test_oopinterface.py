...
def test_qgfield():
    ...
    np.testing.assert_allclose(qref_north_hem[1:-1, 30], np.array([
       ...
       1.06957177e-04, 1.09106934e-04, 1.10848619e-04]), rtol=1.e-5)
    ...
    np.testing.assert_allclose(ptref_north_hem[1:-1, 30], np.array([
        ...
        1672.3165, 1733.3434]), rtol=1.e-5)
    ...
    np.testing.assert_allclose(
            ...
            -6.2088175e-11,  0.0000000e+00]), rtol=1.e-5)
    np.testing.assert_allclose(
            ...
            -1.8538121e-07,  4.2510374e-06]), rtol=1.e-5)
    np.testing.assert_allclose(
        lwa_and_fluxes.meridional_heat_flux[20:40, :].mean(axis=-1), np.array([
            ...
            5.6556517e-05, 5.2262596e-05, 4.7150170e-05, 4.1664603e-05, 3.7316819e-05, 3.1581640e-05]), rtol=1.e-5)
